                    ...
                    <div class="card-body">
                        <form  method="POST" files="true" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="external_student_code" type="text" class="form-control{{ $errors->has('external_student_code') ? ' is-invalid' : '' }}" name="external_student_code" value="{{$student->external_student_code}}"  disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="birthday_date" type="date" class="form-control{{ $errors->has('birthday_date') ? ' is-invalid' : '' }}" name="birthday_date" value="{{ $student->birthday_date}}" required disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="genderMale" name="gender" class="custom-control-input" value="1" required {{($student->gender ==1)? 'checked':'' }} disabled>
                                        <label class="custom-control-label" for="genderMale">Masculino</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="genderWomen" name="gender" class="custom-control-input" value="0" {{($student->gender ==0)? 'checked':'' }} disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="document_number" type="number" class="form-control{{ $errors->has('document_number') ? ' is-invalid' : '' }}" name="document_number" value="{{$student->document_number}}" required disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="education_level" id="education_level" class="custom-select" required disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="workerYes" name="worker" class="custom-control-input" value="1" required {{($student->worker==1)?'checked':'' }} disabled>
                                        <label class="custom-control-label" for="workerYes">Si</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="workerNo" name="worker" class="custom-control-input" value="0" {{($student->worker==0)?'checked':'' }} disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_number" type="number" class="form-control{{ $errors->has('phone_number') ? ' is-invalid' : '' }}" name="phone_number" value="{{ $student->phone_number}}" required disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="cellphone_number" type="number" class="form-control{{ $errors->has('cellphone_number') ? ' is-invalid' : '' }}" name="cellphone_number" value="{{ $student->cellphone_number}}" required disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="meet_way" type="text" class="form-control{{ $errors->has('meet_way') ? ' is-invalid' : '' }}" name="meet_way" value="{{ $student->meet_way}}" required disabled>
                            ...
                            <div class="form-group text-center">
                                @role('user')
                                    <a href="{{route('student.create')}}" class="btn btn-primary btn-block">Registrar</a>
                                @endrole
                                @role('student')
                                    <a href="{{route('student.edit',$student)}}" class="btn btn-primary btn-block">Actualizar</a>
                                @endrole
                            </div>
                        </form>
                    </div>
