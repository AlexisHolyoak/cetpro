            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('student.store')}}" method="POST" files="true" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="student_code" class="col-sm-4 col-form-label text-md-right">Código de estudiante (referencial)*</label>                            
                            <div class="col-md-6">
                                <input id="student_code" type="text" class="form-control{{ $errors->has('student_code') ? ' is-invalid' : '' }}" name="student_code" value="{{$id}}" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="external_student_code" type="text" class="form-control{{ $errors->has('external_student_code') ? ' is-invalid' : '' }}" name="external_student_code" value="{{ old('external_student_code') }}"  >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="genderWomen" name="gender" class="custom-control-input" value="0" @if(old('gender')) checked @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="meet_way" type="text" class="form-control{{ $errors->has('meet_way') ? ' is-invalid' : '' }}" name="meet_way" value="{{ old('meet_way') }}" required >
