  ...
  <div class="row justify-content-center">
    <div class="col-md-10">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{route('career.store')}}" method="POST" files="true" enctype="multipart/form-data">
            @csrf
              ...
              <label for="picture_path" class="col-sm-4 col-form-label text-md-right">Imagen</label>
                <div class="col-md-6">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="picture_path" name="picture_path" aria-describedby="picture_path" onchange="loadFile(event)" autofocus>
                      <label class="custom-file-label" for="picture_path">Selecciona una foto para la carrera</label>
                    </div>
                 </div>  
            </div>
            <div class="form-group row">
