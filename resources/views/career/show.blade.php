...
<div class="container">
    <div class="row">
        <div class="card mx-2 mb-3">
            <img src="{{asset('storage/'.$career->picture_path)}}" alt="{{ $career->name }}" class="card-img-top" width="400"
                height="350">
            <div class="card-body">
                    ...
                    <a class="list-group-item list-group-item-action" href="javascript:void(0);" data-toggle="modal"
                        ...
                        <div class="row">
                            <div class="col-md-2 text-center">
                                <img src="{{asset('storage/'.$course->picture_path)}}" class="rounded-circle" width="75"
                                    height="75" alt="">
                            </div>
                            <div class="col-md-10">
