    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('course.store',$career) }}" method="POST" files="true" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <img id="output_photo" name="output_photo" src="" alt="Imagen" class="card-img-top" width="400"
                                height="350">
                        </div>                        
                            ...
                            <div class="col-md-6">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="picture_path" name="picture_path"
                                        aria-describedby="picture_path" onchange="loadFile(event)" autofocus required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="qualification" id="" class="form-control{{ $errors->has('qualification') ? ' is-invalid' : '' }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" name="hours_quantity" class="form-control{{ $errors->has('hours_quantity') ? ' is-invalid' : '' }}" required>
